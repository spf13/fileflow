...
func Copy(src, dst string) error {
	...
	// Security: Use atomic write pattern to prevent TOCTOU symlink vulnerabilities
	...
	// Apply original file permissions before rename to maintain security
	if err := os.Chmod(tmpName, sourceInfo.Mode()); err != nil {
		destFile = nil
		os.Remove(tmpName)
	...
	destFile = nil // Prevent deferred removal on success
	return nil
}
