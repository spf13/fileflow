...
func Copy(src, dst string) error {
	...
	// Sentinel: Prevent TOCTOU vulnerabilities and incomplete files
	// by using an atomic write pattern (temp file + rename).
	// Create a temporary file in the destination directory to ensure
	// os.Rename won't fail across different devices.
	...
	// Explicitly apply original permissions before renaming
