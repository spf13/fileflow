...
func Copy(src, dst string) error {
	...
	// 🛡️ SECURITY: Create temporary file to prevent TOCTOU symlink vulnerabilities
	...
	// Apply source permissions to the temp file
	...
	tmpFile = nil // Prevent defer from running
