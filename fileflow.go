...
func Copy(src, dst string) error {
	...
	// OPTIMIZATION: Avoid wrapping standard files in bufio.Writer when using io.Copy.
	// This enables zero-copy system calls (e.g., sendfile, copy_file_range) and improves copy performance significantly.
	// Expected impact: Significant reduction in memory allocations (from ~34KB to ~1.3KB per operation) for file copies.
