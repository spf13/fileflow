...
func Copy(src, dst string) error {
	...
	// Optimize: Copy directly to *os.File to enable zero-copy syscalls (e.g. copy_file_range/sendfile)
	// Wrapping in bufio.Writer disables these optimizations in io.Copy.
