...
func Copy(src, dst string) error {
	...
	// Copy the file directly to allow Go to use zero-copy system calls
	// (like sendfile or copy_file_range) when possible. Wrapping destFile
	// in bufio.Writer disables this optimization.
