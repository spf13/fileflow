...
func Copy(src, dst string) error {
	...
	// Create temporary file to prevent TOCTOU symlink vulnerabilities
	// and ensure atomic writes to the destination.
	...
	// Securely apply original file permissions before renaming
