...
func Copy(src, dst string) error {
	...
	// Security note: Using O_EXCL instead of O_TRUNC to prevent TOCTOU race condition
	// where an attacker could create a symlink at the destination path between the
	// Exists check and this OpenFile call.
