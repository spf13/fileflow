...
func Copy(src, dst string) error {
	...
	// SECURITY: Use os.O_EXCL to prevent TOCTOU symlink attacks when creating files
	destFile, err := os.OpenFile(dst, os.O_RDWR|os.O_CREATE|os.O_TRUNC|os.O_EXCL, sourceInfo.Mode())
	if err != nil {
