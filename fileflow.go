...
func Copy(src, dst string) error {
	...
	// Sentinel: Prevent TOCTOU symlink vulnerability by using atomic write pattern.
	// Create temporary file in the destination directory to prevent cross-device rename failures.
