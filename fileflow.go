...
func Copy(src, dst string) error {
	...
	// SEC: Use os.O_EXCL instead of os.O_TRUNC to prevent TOCTOU vulnerability
	// where an attacker could create a symlink between the existence check and this open call
