...
// ⚡ Bolt Optimization: Use sync.Pool to reuse []byte buffers and drastically reduce memory allocations.
// Storing pointers (*[]byte) in the pool prevents interface{} conversion allocations.
