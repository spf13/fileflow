...
// bufferPool reuses large []byte buffers for file operations to reduce
// memory allocations and GC pressure. Expected impact: eliminates 32KB
// allocations per Copy/Equal operation.
