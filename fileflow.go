...
func Copy(src, dst string) error {
	...
	// Copy the file directly using io.Copy. Wrapping standard files in bufio.Writer
	// disables zero-copy system calls (sendfile, copy_file_range) and degrades file copy performance.
