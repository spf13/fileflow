...
func Copy(src, dst string) error {
	...
	// Copy the file directly. Avoiding bufio.Writer allows io.Copy
	// to use zero-copy system calls (like sendfile or copy_file_range)
	// when operating on standard *os.File objects.
