...
func Copy(src, dst string) error {
	...
	// Create temporary destination file in the destination directory to prevent cross-device rename failures
	...
	// Apply source permissions to the temporary file
	...
	destFile = nil // Prevent defer from removing the file after close

	// Atomically rename temporary file to intended destination to prevent TOCTOU vulnerabilities
