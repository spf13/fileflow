...
func Copy(src, dst string) error {
	...
	// Apply original file permissions securely to the temporary file
	...
	destFile = nil // Successful close, prevent double-closing in defer

	// Perform atomic rename over intended destination
