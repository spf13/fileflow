...
func Copy(src, dst string) error {
	...
	// Create destination file securely using atomic write pattern
	// 🛡️ Sentinel: Prevents TOCTOU symlink vulnerabilities during copy
	...
	// Apply original permissions to the temporary file before renaming
