...
func Copy(src, dst string) error {
	...
	// By using raw *os.File directly without a buffer, we allow Go's io.Copy
	// to use the optimized fast path (like sendfile or copy_file_range syscalls),
	// avoiding copying data between kernel and user space.
