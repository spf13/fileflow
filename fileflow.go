...
func Copy(src, dst string) error {
	...
	// Security: Create a temporary file in the destination directory to prevent TOCTOU symlink vulnerabilities
	...
	// Apply original file permissions securely
	...
	destFile = nil // Prevent double close/remove in defer
